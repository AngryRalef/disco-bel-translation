...
// AssetsTools.NET.Cpp2IL/Cpp2IlTempGenerator.cs - reused here (along with its sibling files in
// this directory) to resolve IL2CPP MonoBehaviour layouts headlessly, matching the NuGet
// AssetsTools.NET core package version this tool otherwise uses (the published
// AssetsTools.NET.Cpp2IL NuGet package is version-mismatched against current LibCpp2IL builds).
